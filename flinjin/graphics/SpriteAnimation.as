package flinjin.graphics
{
	...
	public class SpriteAnimation extends EventDispatcher
	{
		 ...
		 */
		public function SpriteAnimation(animationName:String = "default", frames:Array = null, animationSpeed:Number = 100, yoyo:Boolean = false, animationRepeatCount:int = -1)
		{
			_name = animationName;
			_frames = frames;
